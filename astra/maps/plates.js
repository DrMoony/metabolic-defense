...
export const PLATES={
  coronary:{
    ...
    organs:{liver:organ([760,309],212),pancreas:organ([1434,682],209)},
  ...
  omentum:{
    ...
    organs:{liver:organ([510,209],170),pancreas:organ([1475,706],208)},
  ...
  sinusoid:{
    ...
    organs:{liver:organ([829,339],182),pancreas:organ([1468,725],212)},
  ...
  carotid:{
    ...
    organs:{liver:organ([897,444],191),pancreas:organ([234,714],208)},
  ...
  stomach:{
    ...
    organs:{liver:organ([822,371],206),pancreas:organ([1476,756],219)},
  ...
  glomerulus:{
    ...
    organs:{liver:organ([847,456],186),pancreas:organ([1474,797],213)},
  ...
  islet:{
    ...
    organs:{liver:organ([846,399],202),pancreas:organ([842,847],196)},
