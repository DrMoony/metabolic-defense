...
export const PLATES={
  ...
  islet:{
    beta:true,topology:'parallel',camera:{height:24,fov:44,targetZ:-28},
    title:['두 길 사이의 섬','The island between two roads'],subtitle:['합류하지 않는 두 방어선','Two independent defenses'],
    briefing:['좌우 두 길로 적이 내려와요. 중앙 섬 스폰은 지형 재건축과 함께 돌아올 예정이에요 (베타).','Enemies descend the two roads. Core-island spawns return with the terrain rebuild (beta).'],
