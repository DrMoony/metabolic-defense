...
export const PLATES={
  coronary:{
    ...
    organs:{liver:organ([805,510],212),pancreas:organ([1434,682],209)},
  ...
  omentum:{
    ...
    organs:{liver:organ([917,538],170),pancreas:organ([1475,706],208)},
  ...
  sinusoid:{
    ...
    organs:{liver:organ([777,671],182),pancreas:organ([1468,725],212)},
  ...
  carotid:{
    ...
    organs:{liver:organ([947,402],191),pancreas:organ([234,714],208)},
  ...
  stomach:{
    ...
    organs:{liver:organ([699,439],206),pancreas:organ([1476,756],219)},
  ...
  glomerulus:{
    ...
    organs:{liver:organ([844,505],186),pancreas:organ([1474,797],213)},
  ...
  islet:{
    ...
    organs:{liver:organ([444,374],202),pancreas:organ([842,847],196)},
