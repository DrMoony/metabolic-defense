...
export const PLATES={
  coronary:{
    ...
    organs:{liver:organ([133,461],212),pancreas:organ([1533,497],209)},
  ...
  omentum:{
    ...
    organs:{liver:organ([133,235],170),pancreas:organ([1533,495],208)},
  ...
  sinusoid:{
    ...
    organs:{liver:organ([573,261],182),pancreas:organ([1533,521],212)},
  ...
  carotid:{
    ...
    organs:{liver:organ([1553,523],191),pancreas:organ([167,525],208)},
  ...
  stomach:{
    ...
    organs:{liver:organ([1353,283],206),pancreas:organ([1533,300],219)},
  ...
  glomerulus:{
    ...
    organs:{liver:organ([133,276],186),pancreas:organ([1533,522],213)},
  ...
  villi:{
    ...
    organs:{liver:organ([163,509],196),pancreas:organ([1533,525],208)},
  ...
  islet:{
    ...
    organs:{liver:organ([523,497],202),pancreas:organ([1183,519],196)},
